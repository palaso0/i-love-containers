...
import { InspectTab } from "@/features/containers/tabs/InspectTab";

interface StandaloneInspectWindowProps {
  containerId: string;
  containerName?: string;
}

export const StandaloneInspectWindow: React.FC<StandaloneInspectWindowProps> = ({
  containerId,
