...
export function getTechBadgeInfo(image = "", name = "", role = ""): {
  ...
  const tech = detectTech(image, name);
  ...
  switch (tech) {
    ...
    case "mysql":
      return (
        ...
        >
          ...
          />
          <path
            d="M7 14c2-5 6-8 11-8-1 3-3 5-6 6"
            stroke="#F59E0B"
            strokeWidth="2.2"
            strokeLinecap="round"
            strokeLinejoin="round"
          />
          <circle cx="15" cy="8" r="1.2" fill="#F59E0B" />
        </svg>
      );
    ...
    case "python":
      return (
        ...
        >
          ...
          />
          <path
            d="M12 22c4 0 5-1 5-3v-2h-5v-1h7c2 0 3-1 3-4s-1-4-4-4h-2v2c0 2-1 3-3 3H8v2c0 2 1 3 4 3v4h-2z"
            fill="#FACC15"
          />
          <circle cx="9" cy="4.5" r="1" fill="#FFFFFF" />
          <circle cx="15" cy="19.5" r="1" fill="#FFFFFF" />
        </svg>
      );
      ...
      return (
        ...
        >
          ...
          <path
            ...
            fill="#06B6D4"
          />
          <circle cx="18" cy="12" r="3.5" stroke="#06B6D4" strokeWidth="2.2" />
        </svg>
      );
    ...
    case "kafka":
      return (
        <svg
          viewBox="0 0 24 24"
          fill="none"
          className={`${className} shrink-0 drop-shadow-[0_0_6px_rgba(168,85,247,0.4)]`}
        >
          <circle cx="6" cy="12" r="2.5" fill="#A855F7" />
          <circle cx="18" cy="6" r="2.5" fill="#A855F7" />
          <circle cx="18" cy="18" r="2.5" fill="#A855F7" />
          <path d="M6 12l12-6M6 12l12 6" stroke="#C084FC" strokeWidth="1.8" />
        </svg>
      );
    ...
    default:
      ...
      switch (role) {
        ...
        case "cache":
          return <Cpu className={`${className} text-rose-400`} />;
        default:
          return <Box className={`${className} text-primary`} />;
      }
  }
};