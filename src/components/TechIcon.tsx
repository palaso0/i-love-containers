  ...
  switch (tech) {
      ...
      return (
        ...
        >
          ...
          <path
            ...
            strokeLinejoin="round"
          />
          <circle cx="15" cy="8" r="1.2" fill="#D97706" />
        </svg>
      );
      ...
      return (
        ...
        >
          <path
            ...
            fill="#0891B2"
          />
          <circle cx="18" cy="12" r="3.5" stroke="#0891B2" strokeWidth="2" />
        </svg>
      );
    ...
    case "kafka":
      return (
        <svg
          ...
          className={`${className} shrink-0`}
        >
          <circle cx="6" cy="12" r="2.5" fill="#9333EA" />
          <circle cx="18" cy="6" r="2.5" fill="#9333EA" />
          <circle cx="18" cy="18" r="2.5" fill="#9333EA" />
          <path d="M6 12l12-6M6 12l12 6" stroke="#A855F7" strokeWidth="1.8" />
        </svg>
      );
    ...
    default:
      switch (role) {
        ...
        case "cache":
          return <Cpu className={`${className} text-rose-500`} />;
        default:
